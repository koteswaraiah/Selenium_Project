...
public class NewTest {
  ...
  @Test(groups = {"regression"}, dataProvider = "Credentials1", priority = 1)
  public void verify( String x, String y) throws InterruptedException {
  ...
  public Object[][] testData(){
	  Object[][] data = new Object[][] {{"noonekoteswaraia", "noone"},{"noonekoteswaraia","noone"}};
	  return data;
  }
